...
class CommonFS():
    ...
    def valid_root(self,username,filepath):
    ...
    def chown_recursive(self,username,startpath):
    ...
    def make_executable(self,username,filepath):
    ...
    def list_root_paths(self,username, **kwargs):
    ...
    def list_root_dirs_for_user(self,username):
        for patt in list_root_paths(username):
            yield { patt: [ f for f in list_dir_for_user(username,patt) ] }

    def get_filetrees_for_user(self,username):
        for patt in list_root_paths(username):
            yield [ d for d in os.walk(patt) ]

    def get_dir_contents(self,username, dirpath):
    ...
    def create_file(self,username, filepath):
        if not valid_root(username,filepath):
    ...
    def update_file(self,username, filepath, content):
        if not valid_root(username, filepath):
    ...
    def delete_file(self,username, filepath):
        if not valid_root(username,filepath):
    ...
    def create_directory(self,username, filepath):
        if not valid_root(username,filepath):
    ...
    def move_file(self,username, origpath, newpath):
    ...
    def copy_file(self,username, origpath, newpath):
        if not ( valid_root(username,origpath) and valid_root(username,newpath) ):
    ...
    def rename_file(self,username, origpath, newpath):
        if not ( valid_root(username,origpath) and valid_root(username,newpath) ):
